...
exports.rejectPoEmailBody = (po, po_details) => {
	let po_details_html = `
    ...
    <html>
		...
		po.supplier
            ...
            <tr>
                <td class="bolded" >Rejected By:</td>
                <td>${po.rejected_by_name !== null ? po.rejected_by_name : ''}</td>
            </tr>
            <tr>
                <td class="bolded">Rejected On:</td>
                <td>${po.rejected_on !== null ? formatDateLong(po.rejected_on) : ''}</td>
            </tr>
        </table>
